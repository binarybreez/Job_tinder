  ...
  const renderApplicationRow = ({ item }: { item: Application }) => (
    ...
    >
      ...
      <View style={styles.tableCellStatus}>
        ...
        {item.interview_date && item.status === 'interview_scheduled' && (
      ...
      <SafeAreaView style={styles.jobDetailsContainer}>
        ...
        {selectedApplication && (
          <ScrollView style={styles.jobDetailsContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.statusCard}>
                ...
                {selectedApplication.interview_date && (
                  <View style={styles.statusRow}>
                    <Text style={styles.statusLabel}>Interview Date:</Text>
                    <Text style={[styles.statusValue, { color: '#8b5cf6', fontWeight: '600' }]}>
            ...
            {/* Skills Matched */}
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Your Skills Match ({selectedApplication.keyword_match_percentage}%)</Text>
              <Text style={styles.matchSubtext}>
                You matched {selectedApplication.matched_keywords.length} out of {selectedApplication.total_keywords} required skills
              </Text>
              <View style={styles.skillsContainer}>
                {selectedApplication.matched_keywords.map((skill, index) => (
                  <View key={index} style={styles.skillChipMatched}>
                    <Ionicons name="checkmark-circle" size={14} color="#10b981" />
                    <Text style={styles.skillChipTextMatched}>{skill}</Text>
                  </View>
                ))}
              </View>
            </View>
            ...
            <View style={styles.actionButtons}>
              ...
              {selectedApplication.status === 'interview_scheduled' && selectedApplication.interview_date && (
                <TouchableOpacity 
                  style={styles.interviewButton}
                  onPress={() => {
                    Alert.alert('Interview Reminder', `Your interview is scheduled for ${new Date(selectedApplication.interview_date!).toLocaleDateString()}. Good luck!`);
                  }}
                >
                  <Ionicons name="calendar" size={20} color="#8b5cf6" />
                  <Text style={styles.interviewButtonText}>Interview Details</Text>
                </TouchableOpacity>
              )}
      ...
      <View style={styles.filtersRow}>
        <View style={styles.filterGroup}>
          ...
          <View style={styles.filterButtons}>
            {(['all', 'internship', 'job'] as const).map((filterOption) => (
              <TouchableOpacity
                key={filterOption}
                style={[
                  styles.filterButton,
              ...
              >
                <Text style={[
                  ...
                  {filterOption === 'all' ? 'All' : 
                   filterOption === 'internship' ? 'Internships' : 'Jobs'}
                </Text>
              </TouchableOpacity>
            ))}
          </View>
