...
const API_URL = process.env.EXPO_PUBLIC_API_URL; // use EXPO_PUBLIC_ instead of NEXT_PUBLIC_
...
const CreateJob = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/jobs/${userId}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      body: JSON.stringify(description) ,  // send schema-compliant job object
    });
